import { fetchSuperHeroes } from "@/lib/super-hero-api";
import { EmergencyHeroesSection } from "./EmergencyHeroesSection";
import { HeroesCTASection } from "./HeroesCTASection";
import { SafetyTipsSection } from "./SafetyTipsSection";

export default async function SuperHeroHubPage() {
  const heroes = await fetchSuperHeroes();

  return (
    <main className="font-sans">
      {/* Hero: same pattern as events/resource hub */}
      ...
      <EmergencyHeroesSection heroes={heroes} />
      <SafetyTipsSection />
      <HeroesCTASection />
    </main>
  );
